...
const PORTAL_CONFIG_B64 = '';
function portalRuntimeConfig(){
  const fallback={id:'portail',title:'Portail NyXia',shortTitle:'Portail',mission:'',mode:'standard',activeAgents:['diane','nyxia'],formationAgent:'diane'};
  try{
    const raw=String(PORTAL_CONFIG_B64||'');
    if(!raw||raw.indexOf('__PORTAL_CONFIG_B64__')!==-1)return fallback;
    const bytes=Uint8Array.from(atob(raw),c=>c.charCodeAt(0));
    return Object.assign({},fallback,JSON.parse(new TextDecoder().decode(bytes)));
  }catch(_){return fallback}
}
const PORTAL_RUNTIME=portalRuntimeConfig();
...
const ACTIVE_AGENTS = new Set((PORTAL_RUNTIME.activeAgents||['diane','nyxia']).map(x=>String(x||'').toLowerCase()));
...
const FORMATION_AGENT = String(PORTAL_RUNTIME.formationAgent||'diane').toLowerCase();
...
function portalSlug(env) {
  return String((env && (env.PORTAIL || env.PORTAL || env.PORTAL_SLUG)) || PORTAL_RUNTIME.id || 'portail').toLowerCase();
}
...
async function handleChat(request, env) {
  ...
  if (!ACTIVE_AGENTS.has(agent)) {
    return json({ error: 'Personnage non disponible dans ce portail.' }, 403);
  }

  // 🎓 Formation Vivante universelle : chaque personnage actif peut piloter
  // ses propres formations si elles existent dans la CASHFLOW_KV commune.
  try {
  ...
  } catch (e) { /* le chat normal reste disponible */ }
  ...
  systemPrompt += `\n\nCONTEXTE DE CE PORTAIL NYXIA :\nNom : ${PORTAL_RUNTIME.title || 'Portail NyXia'}\nMission : ${PORTAL_RUNTIME.mission || 'Accompagner la personne dans la mission de ce portail.'}\nReste dans ta personnalité propre, mais adapte tes exemples, ton orientation et tes propositions à cette mission. N'invente jamais un produit, un outil, un prix ou une fonction qui ne t'a pas été fourni.`;
  ...
  if (PORTAL_RUNTIME.mode === 'alex-writing' && PORTAIL_ALEX_SCHOOL_AGENTS.has(agent)) systemPrompt += PORTAIL_ALEX_SCHOOL_HIERARCHY_PROTOCOL;
  ...
  if (session && session.email) {
    if (PORTAL_RUNTIME.mode === 'alex-writing' && ALEX_SHARED_LEARNING_AGENTS.has(agent)) {
      try {
    ...
    } else if (PORTAL_RUNTIME.mode === 'alex-writing' && agent === 'nyxia') {
      try {
        alexManuscriptMeta = await getAlexManuscriptMeta(env, session.email);
  ...
  if (PORTAL_RUNTIME.mode === 'alex-writing' && agent === 'diane') systemPrompt += DIANE_CLONE_KNOWLEDGE_PROTOCOL;
...
Tu peux donner une courte mission d'observation adaptée, puis afficher la vidéo.`;
  ...
  async function callModel(model) {
    return await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      headers: {
        ...
        'HTTP-Referer': env.SITE_URL || 'https://nyxia.top',
        'X-Title': 'NyXia — ' + (PORTAL_RUNTIME.title || 'Portail')
      },
      body: JSON.stringify({
        model,
        messages,
  ...
  if (PORTAL_RUNTIME.mode === 'alex-writing' && ALEX_SHARED_LEARNING_AGENTS.has(agent) && session && session.email) {
    try {
